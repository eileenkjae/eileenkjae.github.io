...
The original concept was much larger than the first milestone could support, so the initial sprint focused on proving the combat, ink economy and drawing systems instead of completing the full roguelike structure. B-Rush remains a long-term work in progress. Mixamo clips were used as prototyping animation assets during this stage.`,
            ...
            after: {
                ...
                media: {
                    ...
                    src:
                        ...
                        "assets/projects/b-rush/disegno.mp4",
...

    {
        ...
        alt:
            ...
            "Concept artwork of Evelyn inside the painting.",



        caption:

            "Evelyn#1 — artwork by Matilde Troncati, directed by Elia Martin",
...

    {
        ...
        alt:
            ...
            "Concept artwork of Evelyn outside the painting.",



        caption:

            "Evelyn#2 — artwork by Matilde Troncati, directed by Elia Martin",
...

     {
        ...
        alt:
            ...
            "Concept artwork of Evelyn drawing.",



        caption:

            "Evelyn#3 — artwork by Matilde Troncati, directed by Elia Martin",
...

    {
        ...
        alt:
            ...
            "Concept artwork of corruption.",



        caption:

            "Evelyn#4 — artwork by Matilde Troncati, directed by Elia Martin",
...

    {
        ...
        alt:
            ...
            "Concept artwork of duality.",



        caption:

            "Evelyn#5 — artwork by Matilde Troncati, directed by Elia Martin",
...

    {
        ...
        alt:
            ...
            "Boss health bar UI design for B-Rush.",



        caption:

            "Boss health bar — artwork by Matilde Troncati, directed by Elia Martin",
...

    {
        ...
        alt:
            ...
            "Enemy health bar UI design for B-Rush.",



        caption:

            "Enemy health bar — artwork by Matilde Troncati, directed by Elia Martin",
...

    {
        ...
        alt:
            ...
            "Animated loading screen artwork for B-Rush.",



        caption:

            "Loading screen anim. — artwork by Matilde Troncati, directed by Elia Martin",
